...
describe('ExportInfo component', () => {
    ...
    it('should render a form', () => {
        ...
        expect(wrapper.find('#mainHeading').hostNodes()).toHaveLength(1);
        expect(wrapper.find(TextField)).toHaveLength(3);
        expect(wrapper.find('#layersHeader').hostNodes()).toHaveLength(1);
        expect(wrapper.find('#layersHeader').hostNodes().text()).toEqual('Select Data Sources');
        expect(wrapper.find('#layersSubheader').hostNodes().text()).toEqual('You must choose at least one');
        expect(wrapper.find(List)).toHaveLength(1);
        expect(wrapper.find(ListItem)).toHaveLength(0);
        expect(wrapper.find('#projectionHeader').hostNodes()).toHaveLength(1);
        expect(wrapper.find('#projectionHeader').hostNodes().text()).toEqual('Select Projection');
        expect(wrapper.find('#projectionCheckbox').hostNodes().find(Checkbox)).toHaveLength(1);
        expect(wrapper.find('#formatsHeader').hostNodes()).toHaveLength(1);
        expect(wrapper.find('#formatsCheckbox').hostNodes().find(Checkbox)).toHaveLength(1);
